...
def escolhe_palavra_secreta_sem_consumir_muita_memoria
	avisa_escolhendo_palavra
	arquivo = File.new("dicionario.txt")    #leitura de arquivo
	quantidade_de_palavras = arquivo.gets.to_i #captura a quantidade de palavras (colocamos na primeira linha do arquivo)
	...
	while erros < 5
		...
		if chutou_uma_letra
			...
			if total_encontrado == 0
				...
				avisa_letra_encontrada chute, total_encontrado
			end	
		else
